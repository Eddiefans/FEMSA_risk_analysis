...
El PIB se mueve mucho menos que el activo, quiere decir que tiene menor volatilidad y menor valor esperado. Aunque la acción tiene rendimientos de hasta -18% en algunos años, el crecimiento del PIB se mantiene relativamente estable en los 20 años de análisis, estando en una banda del +- 2%.
...
En la gráfica también se observa que se mueven "juntos" en la mayoría de los periodos. Cuando el PIB tiene una ligera tendencia a la baja, la acción también baja, pero mucho más agresivamente, aunque no siempre se cumple. Ese comportamiento de seguir al PIB pero con mayor volatilidad puiede ser explicado por la volatilidad de un solo agente económico vs la volatilidad de todo el agregado de una economía.
...
Otro factor que permite relacionar ambos comportamientos (PIB y precio de un activo) es el "ciclo económico", si el agregado de una economía está en crecimiento es muy probable que las empresas reporten mejor y crezcan el valor de sus acciones.
