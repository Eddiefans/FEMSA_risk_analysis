...
(EPS <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "EPS", col_types = c("date", "numeric", "numeric", "numeric", "skip", "skip")))
...
(dividendos <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "Dividendos", col_types = c("text", "numeric", "numeric")))
dividendos$`Monto total de dividendos` <- dollar_format()(dividendos$`Monto total de dividendos`) 

(splits <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "Splits", col_types = c("date", "text", "text"))) %>% as_tsibble(index = Fecha)

(razonesL <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "Razones liquidez", col_types = c("text", "numeric", "numeric", "numeric")))

(razonesC <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "Razones Cobertura-Endeudamiento", col_types = c("text", "numeric", "numeric"))) 

(EBITDA <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "EBITDA-Interest Expense", col_types = c("text", "numeric"))) %>% mutate(Anio = tsibble::yearmonth(Anio))

(turnover <- read_excel("C:/Users/AgJo413/Documents/GitHub/Clases/6/Analisis de riesgo/Proyecto final/Proyecto_final.xlsx", sheet = "Receivables Turnover", col_types = c("text", "numeric"))) %>% mutate(Anio = tsibble::yearmonth(Anio))
